// Для категорий
//идея: добавляем в value li названия всех категорий (их берем с сайта), при нажатии на категорию вставляем ее в ссылку, по ссылке получаем все новостные источники, которые публикуют новости данной категории, пишем для них свой интерфейс, с помощью него генерируем апи для каждого нвостоного сайта из найденных, для каждого такого источника, если он доступен, перебираем новости через forEach обращаясь к articles, но такого свойства почему-то нет, хотя по полученной последней ссылке-апи это свойство есть.
//идея реализуется громоздко, было бы проще: клик на категорию (категории точно так же в теге li) -> вставляем категорию в ссылку апи, находятся самые популярные новости этой категории, но, к сожалению, такую возможность не представляет newsapi.org
